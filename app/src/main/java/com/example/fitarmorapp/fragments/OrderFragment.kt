...
import com.example.fitarmorapp.adapter.ProductsAdapter
import com.example.fitarmorapp.adapter.ProductsListener
import com.example.fitarmorapp.databinding.FragmentOrderBinding
import com.example.fitarmorapp.models.Products
import com.example.fitarmorapp.viewmodels.OrderViewModel
...
class OrderFragment : Fragment(), ProductsListener {
    ...
    override fun OnProductsClick(product: Products, position: Int) {
        ...
        findNavController().navigate(R.id.navProducListAct,bundle)
    }
